...
# Autocorrelation – Breusch–Godfrey (lag 4)
# bg_test <- lmtest::bgtest(m0, order = 4)

# (B) Heteroskedasticity – White and Goldfeld–Quandt
...
3. **Interpretability** — meaningful coefficients, multicollinearity and heteroskedasticity controlled.  
